...
//   addGeneration: (generation: GenerationParams) => void;
//   updateGeneration: (id: string, params: Partial<GenerationParams>) => void;
//   toggleSidebar: () => void;
...
//     })),
//   updateGeneration: (id, params) => 
//     set((state) => ({
//       generations: state.generations.map((gen) => 
//         gen.id === id ? { ...gen, ...params } : gen
//       ),
//     })),
